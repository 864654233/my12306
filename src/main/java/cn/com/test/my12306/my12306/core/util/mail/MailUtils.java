...
public class MailUtils {
    ...
    public static String emailUsername = "myself";// 邮件用户

    public static String emailPassword = "ehowkj578";// 邮件密码

    public static String emailSender = "15110242986@139.com";// 发送者

    public static String emailReceiver = "15110242986@139.com";// 发送者
